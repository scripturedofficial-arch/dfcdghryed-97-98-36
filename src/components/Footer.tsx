            ...
            <div className="flex-1 flex flex-col sm:flex-row gap-6 lg:gap-8">
              ...
              <div className="flex-1">
                ...
                <div className="flex space-x-4">
                  ...
                  <Link to="/contact#message" onClick={() => { setTimeout(() => { document.getElementById('message')?.scrollIntoView({ behavior: 'smooth' }); }, 100); }} className="hover:text-gray-300 transition-colors duration-200">
