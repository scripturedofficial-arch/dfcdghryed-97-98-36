...
const FeaturedProducts = ({
  ...
  return <>
      ...
      <div className="flex flex-row gap-4 justify-center items-center bg-background py-8 transition-all duration-300 safe-area-spacing">
        ...
        <button onClick={handle36FiveClick} className={`relative z-10 px-8 py-4 text-lg font-medium transition-all duration-300 transform hover:scale-105 rounded-lg safe-touch-target ${activeButton === "36Five" ? "bg-black text-white hover:bg-gray-800" : "border-2 border-black text-white hover:bg-black hover:text-white"}`}>
          36Five
        </button>
        <button onClick={handleThe12Click} className={`relative z-10 px-8 py-4 text-lg font-medium transition-all duration-300 transform hover:scale-105 rounded-lg safe-touch-target ${activeButton === "The12" ? "bg-black text-white hover:bg-gray-800" : "border-2 border-black text-black sm:text-white hover:bg-black hover:text-white"}`}>
          The 12
        </button>
      </div>
